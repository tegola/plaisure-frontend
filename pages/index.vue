<template>
	<div>
		<div class="hero">
			<div class="hero__background d-none d-lg-block" role="presentation">
				<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="hero__background-img">
				...
				<div class="container">
					<div class="row">
								...
								<div class="col-sm mb-2 mb-0">
									<div class="position-relative">
										...
										<pg-place-textbox
											...
											class="form-control-lg search__form-control search__query-control"
										...
										<client-only>
											<div
												...
												class="search__locate-btn-wrapper">
												<pg-button
						...
						<div class="col-md-5 position-relative">
							<div class="main-venue__container">
		...
		<div class="my-5 promote-section">
			<div class="container">
				<div class="row align-items-md-center">
					<div class="col-md-3 mx-auto">
						<img
							src="@/assets/svg/illustrations/venue.svg"
							class="promote-section__img">
					</div>
